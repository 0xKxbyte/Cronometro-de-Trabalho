...
[![Platform](https://shields.io)](https://www.microsoft.com)
[![License](https://shields.io)](https://opensource.org)

![Banner Re:Zero](https://criticalhits.com.br/wp-content/uploads/2021/05/H2x1_NSwitch_ReZeroStartingLifeInAnotherWorldTheProphecyOfTheThrone_1_image1600w.jpg)
...
2. Clone o repositorio para a sua maquina local:
   ```bash
   git clone https://github.com/0xKxbyte/Cronometro-de-Trabalho.git
   ```
